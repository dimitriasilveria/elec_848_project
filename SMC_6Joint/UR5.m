...
% R_1 = vpa(R_1,3);
R_1 = vpa(mapSymType(vpa(R_1),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
% R_2 = vpa(R_2,3);
R_2 = vpa(mapSymType(vpa(R_2),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
% R_3 = vpa(R_3,3);
R_3 = vpa(mapSymType(vpa(R_3),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
% R_4 = vpa(R_4,3);
R_4 = vpa(mapSymType(vpa(R_4),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
% R_5 = vpa(R_5,3);
R_5 = vpa(mapSymType(vpa(R_5),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
p_1 = vpa(mapSymType(vpa(p_1),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_2 = vpa(mapSymType(vpa(p_2),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_3 = vpa(mapSymType(vpa(p_3),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_4 = vpa(mapSymType(vpa(p_4),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_5 = vpa(mapSymType(vpa(p_5),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_6 = vpa(mapSymType(vpa(p_6),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
T = vpa(mapSymType(vpa(T),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
...
p_c1 = vpa(mapSymType(vpa(p_c1),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_c2 = vpa(mapSymType(vpa(p_c2),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_c3 = vpa(mapSymType(vpa(p_c3),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_c4 = vpa(mapSymType(vpa(p_c4),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_c5 = vpa(mapSymType(vpa(p_c5),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
p_c6 = vpa(mapSymType(vpa(p_c6),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),3);
%% SYSTEM's STATEs
...
Jacobi = [J_v6;J_o6];
Jacobi = vpa(mapSymType(vpa(Jacobi),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),4);
...
M = vpa(mapSymType(vpa(M),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),4);
...
C = vpa(mapSymType(vpa(C),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),4);
...
G = vpa(mapSymType(vpa(G),'vpareal',@(x) piecewise(abs(x)<=threshold, 0,x)),4);
